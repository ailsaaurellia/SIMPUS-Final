...
import tabelModel.TabelAnggota;
...
public class FormAnggota extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTableAng.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableAngMouseClicked(evt);
            }
        });
    ...
    private void btHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btHapusActionPerformed
        String s = (String) jTableAng.getValueAt(jTableAng.getSelectedRow(), 1);
    ...
    private void jTableAngMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableAngMouseClicked
    ...
    }//GEN-LAST:event_jTableAngMouseClicked
    ...
    private void setColWidht() {
        ...
        TableColumnModel tblModel = jTableAng.getColumnModel();
