...
import persisten.PeminjamanSkripsi;
import persisten.PeminjamanSkripsiPK;
 ...
 * @author Ailsa
 */
public class FormPeminjamanSkripsi extends javax.swing.JPanel {
    ...
    public FormPeminjamanSkripsi() {
        try {
            ...
            Logger.getLogger(FormPeminjamanSkripsi.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Peminjaman Skripsi Perpustakaan");
        ...
        jLabel6.setText("Tambah Data Peminjaman Skripsi");
        ...
        tf_idSkripsi.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        tf_idSkripsi.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        tf_idSkripsi.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(202, 50, 0)));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(202, 50, 0));
        jLabel13.setText("Judul");

        tbl_skripsi.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        tbl_skripsi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Judul", "Program Studi", "Penulis", "Pembimbing"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PilihSkripsi ps = new PilihSkripsi(null, true);
        ps.setVisible(true);

        String id = ps.mod.getIdSkripsi();
        String judul = ps.mod.getJudul();
        String prodi = ps.mod.getProgramStudi();
        String penulis = ps.mod.getPenulis();
        String pembimbing = ps.mod.getPembimbing();
        tbl.addRow(new Object[]{id, judul, prodi, penulis, pembimbing});

        Skripsi bukuTerpilih = ps.getSkripsiTerpilih();
        if (bukuTerpilih != null) {
            tf_idSkripsi.setText(bukuTerpilih.getIdSkripsi());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        DefaultTableModel tbl = (DefaultTableModel) tbl_skripsi.getModel();
        int index = tbl_skripsi.getSelectedRow();
        try {
            tbl.removeRow(index);
        } catch (IndexOutOfBoundsException e) {
            JOptionPane.showMessageDialog(null, "Pilih baris yang ingin dihapus");
        }
        tbl_skripsi.setModel(tbl);
        jLabel1.requestFocus();
    ...
    private void getData(DefaultTableModel model) {
        ...
        try {
            ...
            TypedQuery<PeminjamanSkripsi> querySelectAll = em.createNamedQuery("PeminjamanSkripsi.findAll", PeminjamanSkripsi.class);
            List<PeminjamanSkripsi> results = querySelectAll.getResultList();

            for (PeminjamanSkripsi pinjamSkripsi : results) {
                PeminjamanSkripsiPK pk = pinjamSkripsi.getPeminjamanSkripsiPK();
                model.addRow(new Object[]{
                    pk.getNoPeminjamanSkripsi(),
                    pk.getIdPengguna(),
                    pinjamSkripsi.getNama(),
                    pinjamSkripsi.getAngkatan(),
                    pk.getIdSkripsi(),
                    pinjamSkripsi.getJudulSkripsi(),
                    pinjamSkripsi.getStatusPeminjaman(),
                    pinjamSkripsi.getTanggalPinjam(),
                    pinjamSkripsi.getTanggalKembali()
                });
            }
    ...
    private void insertData() {
        ...
        String idBuku = tf_idSkripsi.getText();
    ...
    private void dataTabel() {
        ...
        tf_idSkripsi.setText(jTablePinjam.getValueAt(row, 4).toString());
        ...
        DefaultTableModel tblBukuModel = (DefaultTableModel) tbl_skripsi.getModel();
