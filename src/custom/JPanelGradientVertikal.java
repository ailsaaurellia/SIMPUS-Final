 ...
 * @author fatiq
 */
public class JPanelGradientVertikal extends JPanel {

    private Color CStart = Color.black;
    private Color CEnd = Color.white;
    
    public JPanelGradientVertikal() {
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gd = new GradientPaint(getWidth()/2,0, CStart, getWidth()/2,getHeight(), CEnd);
        g2d.setPaint(gd);
