 ...
 * @author fatiq
 */
public class JPanelGradientHorizontal extends JPanel {

    private Color CStart = Color.black;
    private Color CEnd = Color.white;
    
    public JPanelGradientHorizontal() {
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gd = new GradientPaint(0,getHeight()/2, CStart, getWidth(),getHeight()/2, CEnd);
        g2d.setPaint(gd);
